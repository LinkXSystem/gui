 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const A=new class{handleAttributeExpressions(t,e,n,s){const i=e[0];if("."===i){return new E(t,e.slice(1),n).parts}if("@"===i)return[new V(t,e.slice(1),s.eventContext)];if("?"===i)return[new N(t,e.slice(1),n)];return new b(t,e,n).parts}handleTextExpression(t){return new y(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const M=(t,...e)=>new _(t,e,"html",A);class I{constructor(t){this.element=t}rotate(){}scale(){}translate(){}skew(){}matrix(t){const e=t||new Array(9).fill(0);if(this.element){const t=e.join(", ");this.element.style.transform=`matrix(${t})`}return this}}class P{constructor(t){this.element=t}setStyle(t){Object.entries(t).forEach((t=>{const[e,n]=t;this.element.style[e]=n}))}}class R extends HTMLElement{constructor(){super(),this._render()}static register(t){window.customElements.define(`${t}-element`,R)}connectedCallback(){console.warn("the unimplemented function: connectedCallback ！")}disconnectedCallback(){console.warn("the unimplemented function: disconnectedCallback ！")}adoptedCallback(){console.warn("the unimplemented function: adoptedCallback ！")}attributeChangedCallback(t,e,n){console.warn("the unimplemented function: attributeChangedCallback ！")}_handleInitialStyle(t){const e=document.createElement("style");t.appendChild(e)}_render(){const t=this.attachShadow({mode:"open"}),e=document.createElement("div");t.appendChild(e),this._handleInitialStyle(t);const n=this.render();this.element=e,this.primitive=new I(e),this.sheet=new P(e),n&&((t,e,n)=>{let i=$.get(e);void 0===i&&(s(e,e.firstChild),$.set(e,i=new y(Object.assign({templateFactory:T},n))),i.appendInto(e)),i.setValue(t),i.commit()})(n,e)}render(){}}class H extends R{static register(t){window.customElements.define(`${t}-box`,H)}constructor(){super()}connectedCallback(){const t=this.getAttribute("onRef");console.warn(t)}render(){return M`
        ...
        `}}class F{constructor(){}static getInstance(){return O||(O=new F),O}getEventStack(){return this._EventStackCache||(this._EventStackCache=[]),this._EventStackCache}}let O;class q extends R{static register(t){window.customElements.define(`${t}-tool`,q)}static get observedAttributes(){return["command","tooltip"]}constructor(){super()}connectedCallback(){const t=this.shadowRoot;(null==t?void 0:t.querySelector(".tool"))&&this.addEventListener("click",this._handleClick.bind(this))}attributeChangedCallback(t,e,n){const s=this.shadowRoot,i=null==s?void 0:s.querySelector(".tool");i&&(i.dataset[t]=n)}_handleClick(t){const e=this.shadowRoot,n=null==e?void 0:e.querySelector(".tool");if(n){let t={};t.node=n,t.timestamp=window.performance.now(),Array.from(n.attributes).forEach((e=>{const{name:n,value:s}=e;t[n]=s}));const e=F.getInstance().getEventStack();e&&e.push(t)}}_handleInitialStyle(t){const e=document.createElement("style");e.textContent="\n            .tool {\n                cursor: pointer;\n\n                display: flex;\n                align-items: center;\n                justify-content: center;\n\n                width: 32px;\n                height: 32px;\n\n                transition: background 0.3s ease-in-out;\n            }\n\n            .tool:hover {\n                color: #ffffff;\n                background: #efefef;\n            }\n        ",t.appendChild(e)}render(){return M`
            <div class="tool">
                <slot></slot>
            </div>
        `}}class W extends R{static register(t){window.customElements.define(`${t}-icon`,W)}static get observedAttributes(){return["prefix","icon"]}constructor(){super()}connectedCallback(){const t=this.getAttribute("onRef");console.warn(t)}attributeChangedCallback(t,e,n){const s=this.shadowRoot;if(s){const t=s.querySelector(".icon");null==t||t.classList.add(n)}}render(){return M`
            <i class="icon">add</i>
        `}}const B="v0.0.2";var U={getRuntime:function(){return F.getInstance()},render:function(t,e){const n=(new DOMParser).parseFromString(t,"text/xml");n.firstElementChild&&e.appendChild(n.firstElementChild)},register:function(t,e,n){e instanceof Array?e.forEach((e=>{e.register(t)})):e.register(),n&&n()}};export default U;export{H as Box,W as Icon,q as Tool,j as Toolbar,B as version};
